package com.AntoniusSimanjuntak.recyclerview

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.AntoniusSimanjuntak.recyclerview.adapter.AdapterTeamBola
import com.AntoniusSimanjuntak.recyclerview.databinding.ActivityMainBinding
import com.AntoniusSimanjuntak.recyclerview.model.Pemain
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listPemain.add(Pemain("Zinedine Yazid Zidane",R.drawable.zidan,"PPelatih","1,85 m","Marseille (Prancis)","23 Juni 1972"))
